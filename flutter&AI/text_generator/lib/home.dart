...
import 'package:text_generator/generatedcaptions.dart';
...
class _HomeState extends State<Home> {
  ...
  Future<Map<String, dynamic>> fetchResponse(File image) async {
    ...
    final imageUploadRequest = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://max-image-caption-generator-test.2886795272-80-hazel04.environments.katacoda.com/model/predict'));
